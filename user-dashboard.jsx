...
export function UserDashBoard(){
    ...
    return(
        <div className="bg-light p-2 m-2">
            <h3 className="d-flex justify-content-between"><div><span>{cookies['username']}</span> <span>Dashboard</span></div> <div><button>{store.getState().store.VideosCount}</button></div> <div><button onClick={handleSignout} className="btn btn-link">Signout</button></div>   </h3>
            <div className="row">
                <div className="col-2">
                    <div className="mb-3">
                    ...
                    videos.map(video=>
                        <div className="card m-2 p-2" style={{width:'250px'}}>
                            ...
                            <div className="card-body">
                                <iframe title="Video" src={"https://www.youtube.com/embed/Q-NMOPlOH40&t=2s"} className="w-100" height="200"></iframe>
                            </div>
